    ...
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        <View style={[styles.row, styles.heading]}>
          <RkText rkType='primary header6'>Perfil</RkText>
        </View>
        ...
        <View style={styles.row}>
          <TouchableOpacity style={styles.rowButton}>
            <RkText rkType='header6'>Mudar senha</RkText>
          </TouchableOpacity>
        </View>
        <View style={styles.row}>
          <RkText rkType='header6'>Enviar notificações push</RkText>
          <RkSwitch
            style={styles.switch}
        ...
        <View style={styles.row}>
          <RkText rkType='header6'>Atualizar Automaticamente</RkText>
          <RkSwitch
            style={styles.switch}
      ...
      <View style={styles.section}>
        <View style={[styles.row, styles.heading]}>
          <RkText rkType='primary header6'>ENCONTRAR AMIGOS</RkText>
        </View>
        <View style={styles.row}>
        </View>
        <View style={styles.row}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          <TouchableOpacity style={styles.rowButton}>
            <RkText rkType='header6'>Política e Privacidade</RkText>
          </TouchableOpacity>
        </View>
        <View style={styles.row}>
          <TouchableOpacity style={styles.rowButton}>
            <RkText rkType='header6'>Termos & Condições</RkText>
          </TouchableOpacity>
        </View>
        <View style={styles.row}>
          <TouchableOpacity style={styles.rowButton}>
