  ...
  render = () => (
    <RkAvoidKeyboard
      ...
      <View style={styles.container}>
        ...
        <RkTextInput rkType='rounded' placeholder='Insira seu email' />
        <RkTextInput rkType='rounded' placeholder='Insira sua senha' secureTextEntry />
        <GradientButton
          style={styles.save}
          rkType='large'
        ...
        <View style={styles.footer}>
          <View style={styles.textRow}>
            ...
            <RkButton rkType='clear'>
              <RkText rkType='header6' onPress={this.onSignUpButtonPressed}>Inscreva-se agora</RkText>
            </RkButton>
          </View>
        </View>
      </View>
